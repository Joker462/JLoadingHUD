//
//  BallPulseOpacityRippleLayer.swift
//  JLoadingHUD
//
...
final class BallPulseOpacityRippleLayer: BasicProgressLayer {
    // Properties
    ...
    private lazy var ballAnimation: CAAnimation = {
        ...
        let opacityOutAnimation = getOpacityOutAnimation()
        opacityOutAnimation.beginTime = DURATION
        
        let scaleAnimationGroup = CAAnimationGroup()
        scaleAnimationGroup.animations = [scaleInAnimation,
                                          getOpacityInAnimation(),
                                          scaleOutAnimation,
                                          opacityOutAnimation]
    ...
    private lazy var middleBallAnimation: CAAnimation = {
        ...
        let opacityInAnimation = getOpacityInAnimation()
        opacityInAnimation.beginTime = DURATION
        
        let scaleAnimationGroup = CAAnimationGroup()
        scaleAnimationGroup.animations = [scaleOutAnimation,
                                          getOpacityOutAnimation(),
                                          scaleInAnimation,
                                          opacityInAnimation]
        scaleAnimationGroup.duration = DURATION*2
        scaleAnimationGroup.repeatCount = .greatestFiniteMagnitude
...
private extension BallPulseOpacityRippleLayer {
    func renderLayer() {
    ...
    func getOpacityInAnimation() -> CABasicAnimation {
    ...
    func getOpacityOutAnimation() -> CABasicAnimation {
        let opacityAnimation = CABasicAnimation(keyPath: "opacity")
